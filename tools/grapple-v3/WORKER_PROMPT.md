...
### Stage 2 — REVIEWER
Spawn a reviewer subagent via sessions_spawn with model `codex.claude.gg/gpt-5.2-codex`:
...
### Stage 4 — JUDGE
Spawn a judge subagent via sessions_spawn with model `app-claude/claude-opus-4-6`:
